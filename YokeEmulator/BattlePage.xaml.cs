    ...
    public sealed partial class BattlePage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (localSettings.Values.ContainsKey("BTNLABEL8"))
                batButtonsPanel.Btn1Text = localSettings.Values["BTNLABEL8"].ToString();
            if (localSettings.Values.ContainsKey("BTNLABEL9"))
                batButtonsPanel.Btn2Text = localSettings.Values["BTNLABEL9"].ToString();
            ...
            batButtonsPanel.DoubleTappedProperty= App.batBtnPanelDTapped;
